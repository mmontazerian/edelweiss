...
// // Function to enable or disable AOS CSS based on screen size
// function toggleAOS() {
//   const aosStylesheet = document.getElementById('aos-stylesheet');
//   if (window.innerWidth < 1024) {
//     if (aosStylesheet) {
//       aosStylesheet.disabled = true;
//     }
//   } else {
//     if (aosStylesheet) {
//       aosStylesheet.disabled = false;
//     }
//   }
// }
...
//         iconMenu.style.display = 'none'; // Hide the ☰ icon
//         iconX.style.display = 'block'; // Show the ✕ icon
//     } else {
//         navItems.style.display = 'none';
//         iconMenu.style.display = 'block'; // Show the ☰ icon
//         iconX.style.display = 'none'; // Hide the ✕ icon
//     }
// });
...
//         // Enable AOS CSS for screen sizes larger than 768px
//         toggleAOS();
//     } else {
//         navItems.style.display = 'none';
//         iconMenu.style.display = 'block';
//         iconX.style.display = 'none';
//         // Disable AOS CSS for screen sizes less than 768px
//         toggleAOS();
//     }
// });
...
//     let fromTop = window.scrollY + navbar.offsetHeight + 1; // Consideration for the height of the navbar + 1px buffer
...
// navLinks.forEach(link => {
//     link.addEventListener('click', function() {
//         // If it's in mobile view, close the menu after clicking a link
//         if (window.innerWidth <= 768) {
//             navItems.style.display = 'none';
//             // Assuming you still want to change the menu icon to its original state
